...
const [isActive,setIsActive ]=useState(false)
    return <div className="flex justify-center items-center">
                  <div className="border-2 border-dashed  w-96 h-12 border-blue-500 flex justify-between items-center flex-row mt-2 rounded-md md:w-[1100px]">
                     ...
                     <span className="hidden md:flex md:justify-between md:w-96 ">
                          <ul className="md:flex md:flex-row justify-between md:w-96 md:text-center md:my-auto">
                               ...
                               <Link smooth to="#services" className="cursor-pointer md:text-center md:my-auto md:text-[10px]  text-[#6E2DFA]">Services</Link>
