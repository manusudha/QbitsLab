...
export default function Getintouch(){
    const email= "lab.qbits@gmail.com";
    ...
    const CopyEmail =async()=>{
            try{
                await navigator.clipboard.writeText(email)
                 ...
                 setTimeout(()=>{setIsCopied(false);console.log(isCopied)},5000)
                 
                

            }catch(e){
              console.log("not able to copied",e)
            }
    }
    return <div id="getintouch"className=" text-sm flex flex-col items-center w-full m-auto py-16 md:py-20 lg:py-24">                 
                                ...
                                <div className="text-gray-600 mt-6 text-xl text-center">Have a Idea in mind ? Reach out through below Channel </div>
                                <div className="h-32 w-72 bg-white border border-gray-300 rounded-md flex flex-row gap-8 justify-center items-center hover:text-[#6E2DFA] hover:border-[#6E2DFA] mt-8 cursor-pointer "  onClick={CopyEmail} >
                                ...
                                {isCopied?"✅ Email copied successfully !":""}
           </div>
}
