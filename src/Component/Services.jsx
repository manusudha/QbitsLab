                    ...
                    {/*---------------------*/}
                     <div className=" relative w-76 h-[257px] bg-white justify-center text-center rounded-md flex flex-col border border-gray-100  hover:border-[#6E2DFA] hover:text-[#6E2DFA]">   
                        <div className="h-[60px]">
                            <div className="absolute flex justify-center bg-gray-200 transition delay-150 items-center border border-blue-400 w-[25px] h-[25px] left-[4%] top-[0%] rounded-md hover:bg-[#6E2DFA] hover:text-white ">
                        ...
                        <div className="flex flex-col gap-6 h-[240px] ">
                            <div className="text-justify font-bold hover:text-[#6E2DFA] text-sm">Custom Software And WebApps/websites</div>
                                ...
                                <div className="flex flex-row gap-6">
                                    ...
                                    <span className="text-center w-16 bg-gray-100 text-gray-500 rounded-md text-sm">Node.js</span>
                                </div>
                            <div className="text-[#6E2DFA] cursor-pointer flex gap-20 justify-start items-center text-sm">Learn More <svg xmlns="http://www.w3.org/2000/svg" width="15" height="" viewBox="0 0 24 24"><path fill="none" stroke="#6E2DFA" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7-7l7 7l-7 7"/></svg></div>
                        </div>
                     </div>
                     {/*--------------*/}
                     <div className=" relative w-76 h-[257px] bg-white justify-center text-center rounded-md flex flex-col border border-gray-100  hover:border-[#6E2DFA] hover:text-[#6E2DFA]">   
                        ...
                        <div className="flex flex-col gap-6 h-[240px] ">
                            <div className="text-justify font-bold text-sm">API & Integration</div>
                                <article ><p className="text-justify leading-relaxed text-gray-600 text-sm ">connect everything. we design custom API's orchestrate third-party system(CRM, payment gateways). and enable real-time data sync and automation</p></article>
                                <div className="flex flex-row gap-6">
                                    <span className="text-center w-16 bg-gray-100 text-gray-500 rounded-md text-sm">APIs</span>
                                    <span className="text-center w-18 bg-gray-100 text-gray-500 rounded-md text-sm">Integration</span>
                                    <span className="text-center w-18 bg-gray-100 text-gray-500 rounded-md text-sm">Real-Time</span>
                                </div>
                            <div className="text-[#6E2DFA] cursor-pointer flex gap-20 justify-start items-center text-sm">Learn More <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="none" stroke="#6E2DFA" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7-7l7 7l-7 7"/></svg></div>
                        </div>
                     </div>
                     {/*-------------*/}
                     <div className=" relative w-76 h-[257px] bg-white justify-center text-center rounded-md flex flex-col border border-gray-100  hover:border-[#6E2DFA] hover:text-[#6E2DFA]">   
                        ...
                        <div className="flex flex-col gap-6 h-[240px]">
                            <div className="text-justify font-bold hover:text-[#6E2DFA] text-sm">AI chatbots & Assistants</div>
                                ...
                                <div className="flex flex-row gap-6">
                                    ...
                                    <span className="text-center w-18 bg-gray-100 text-gray-500 rounded-md text-sm">Firestore</span>
                                </div>
                            <div className="text-[#6E2DFA] cursor-pointer flex gap-20 justify-start items-center text-sm">Learn More <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24"><path fill="none" stroke="#6E2DFA" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14m-7-7l7 7l-7 7"/></svg></div>
                        </div>
                     </div>
